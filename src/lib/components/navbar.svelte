...
>
    <div class="bg-white/20 dark:bg-neutral-900/20 backdrop-blur-md border border-white/30 dark:border-neutral-700/30 px-8 py-3 rounded-full flex items-center gap-8 shadow-lg">
        <a 
            href="/" 
            class="flex items-center gap-2 {$page.url.pathname === '/' ? 'text-black/90 dark:text-white' : 'text-black/60 dark:text-neutral-400'} hover:text-black dark:hover:text-white transition-colors"
        >
        ...
        <a 
            href="/aboutme" 
            class="flex items-center gap-2 {$page.url.pathname === '/aboutme' ? 'text-black/90 dark:text-white' : 'text-black/60 dark:text-neutral-400'} hover:text-black dark:hover:text-white transition-colors"
        >
        ...
        <a 
            href="/projects" 
            class="flex items-center gap-2 {$page.url.pathname === '/projects' ? 'text-black/90 dark:text-white' : 'text-black/60 dark:text-neutral-400'} hover:text-black dark:hover:text-white transition-color"
        >
        ...
        <a 
            href="/blogs" 
            class="flex items-center gap-2 {$page.url.pathname === '/blogs' ? 'text-black/90 dark:text-white' : 'text-black/60 dark:text-neutral-400'} hover:text-black dark:hover:text-white transition-colors"
        >
