          ...
          {images.map((image, index) => {
            const slideContent = (
              <>
                ...
                />
                {image.caption && (
                  <div className="absolute inset-x-0 bottom-0 bg-gradient-to-t from-black/80 to-transparent p-3 text-sm font-medium text-white">
                    {image.caption}
                  </div>
                )}
              </>
            ...
            return (
              <SwiperSlide key={index} className="relative">
                {image.href ? (
                  <a href={image.href} target="_blank" rel="noopener noreferrer" className="relative block h-full w-full">
                    {slideContent}
                  </a>
                ) : (
